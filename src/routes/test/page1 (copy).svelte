    ...
    try {
      ...
      if (Array.isArray(submissionData.file) && submissionData.file.length > 0) {
        try {
          ...
          // Kirim objek yang sudah dimodifikasi
          handleEvent("onSubmit", eventToSubmit);
          hideLoaderPopup();
          
          // MODIFIED: Show post-submission modal instead of alert + history back
        ...
        try {
          ...
          handleEvent("onSubmit", submissionData);
          hideLoaderPopup();
  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white p-8 rounded-lg shadow-lg w-96 max-w-md mx-4">
      <div class="text-center">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-4">Berhasil Submit!</h3>
