import * as server from '../entries/pages/task/_page.server.js';

export const index = 11;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/task/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/task/+page.server.js";
