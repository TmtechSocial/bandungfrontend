...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n  <head>\n    \n    <meta charset="utf-8" />\n    <link rel="icon" href="' + assets2 + '/favicon.svg" />\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\n    ' + head + '\n	<link\n      rel="stylesheet"\n      href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css"\n      crossorigin="anonymous"\n    />\n    <link\n      rel="stylesheet"\n      href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css"\n      crossorigin="anonymous"\n    />\n    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">\n    <link\n      rel="stylesheet"\n      href="https://cdn.form.io/formiojs/formio.form.min.css"\n      crossorigin="anonymous"\n    />\n        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">\n    <style>\n     /* Base styles - maintain existing code */\nth:has(span.sr-only) {\n  display: none !important;\n}\n\ntbody[data-key="datagrid-products"] td.col-1 {\n  display: none !important;\n}\n\n\n\n.big-font input {\n  font-size: 23px;\n  font-weight: bold;\n}\n\n/* Enhanced responsive styles for mobile view */\n@media screen and (max-width: 767px) {\n  /* Hide table headers on mobile except the product name header */\n  .datagrid-table thead tr th:not(:first-child) {\n    display: none;\n  }\n  \n  .datagrid-table thead tr th:first-child {\n    display: block;\n    width: 100%;\n    background-color: #f8f9fa;\n    padding: 0.75rem;\n    text-align: center;\n    font-size: 1.1rem;\n    border-bottom: 2px solid #dee2e6;\n  }\n  \n  /* Change table display from table to block */\n  .datagrid-table, \n  .datagrid-table tbody, \n  .datagrid-table tr {\n    display: block;\n    width: 100%;\n  }\n  \n  /* Create card-like layout for each row */\n  .datagrid-table tbody tr {\n    margin-bottom: 1.5rem;\n    border: 1px solid #dee2e6;\n    border-radius: 0.5rem;\n    padding: 0.75rem;\n    box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075);\n    background-color: #ffffff;\n    position: relative;\n    overflow: hidden;\n  }\n  \n  /* Make all cells block-level and reset border */\n  .datagrid-table td {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n    align-items: center;\n    padding: 0.75rem 0.5rem;\n    border: none !important;\n    border-bottom: 1px solid rgba(0,0,0,0.05) !important;\n    position: relative;\n    min-height: 3.5rem;\n  }\n \n  .datagrid-table td:before {\n    font-weight: 600;\n    color: #495057;\n    flex: 0 0 40%;\n    max-width: 40%;\n    padding-right: 1rem;\n    text-align: left;\n    font-size: 0.9rem;\n  }\n  \n  /* Style the product name cell */\n  .datagrid-table td:nth-of-type(1) {\n    display: block;\n    padding: 0.75rem 0.5rem;\n    font-weight: 600;\n    background-color: #f8f9fa;\n    border-bottom: 1px solid #dee2e6 !important;\n    border-top-left-radius: 0.45rem;\n    border-top-right-radius: 0.45rem;\n    margin: -0.75rem -0.75rem 0.75rem -0.75rem;\n    font-size: 1rem;\n    line-height: 1.4;\n  }\n  \n  /* Hide the product name label */\n  .datagrid-table td:nth-of-type(1):before {\n    display: none;\n  }\n  \n  /* Product name container */\n  .datagrid-table td:nth-of-type(1) .formio-component {\n    width: 100%;\n  }\n  \n  /* Make sure long product names wrap properly */\n  .datagrid-table td:nth-of-type(1) .formio-editor-read-only-content {\n    white-space: normal;\n    word-break: break-word;\n    hyphens: auto;\n  }\n  \n  /* Handle form components */\n  .datagrid-table td .formio-component {\n    flex: 0 0 55%;\n    max-width: 55%;\n    margin-bottom: 0;\n  }\n  \n  /* Format the inputs */\n  .datagrid-table td input[type="text"],\n  .datagrid-table td input[type="number"] {\n    width: 100%;\n    text-align: right;\n    padding: 0.375rem 0.75rem;\n    font-size: 1rem;\n    min-height: 38px;\n    border-radius: 0.25rem;\n  }\n  \n  /* Make the SKU field stand out with monospace font */\n  .datagrid-table td:nth-of-type(2) input {\n    font-family: monospace;\n    font-weight: 600;\n    letter-spacing: 0.5px;\n    text-align: center;\n    background-color: #f8f9fa;\n    font-size: 1.1rem;\n  }\n  \n  /* Format quantity fields */\n  .datagrid-table td:nth-of-type(3) input,\n  .datagrid-table td:nth-of-type(4) input {\n    font-weight: 600;\n    font-size: 1.1rem;\n    text-align: center;\n  }\n  \n  /* Highlight the quantity check field */\n  .datagrid-table td:nth-of-type(4) input {\n    background-color: #fff9db;\n    border-color: #ffc107;\n  }\n  \n  /* Style checkbox containers */\n  .datagrid-table td:nth-of-type(5),\n  .datagrid-table td:nth-of-type(6) {\n    min-height: 4rem;\n  }\n  \n  /* Checkbox size and alignment */\n  .datagrid-table td:nth-of-type(5) .form-check,\n  .datagrid-table td:nth-of-type(6) .form-check {\n    display: flex;\n    justify-content: flex-end;\n    align-items: center;\n    padding: 0;\n    margin: 0;\n    width: 100%;\n  }\n  \n  /* Additional styling for checkboxes */\n  .datagrid-table td:nth-of-type(5) input[type="checkbox"],\n  .datagrid-table td:nth-of-type(6) input[type="checkbox"] {\n    transform: scale(1);\n    margin: 0;\n    cursor: pointer;\n    padding: 10px;\n    height: 25px;\n    width: 25px;\n  }\n  \n  /* Style the "Add Another" button */\n  .datagrid-table tfoot {\n    display: block;\n    margin-top: 1rem;\n  }\n  \n  .datagrid-table tfoot tr {\n    display: block;\n  }\n  \n  .datagrid-table tfoot td {\n    display: block;\n    padding: 0.5rem;\n    text-align: center;\n  }\n  \n  .datagrid-table .formio-button-add-row {\n    width: 100%;\n    padding: 0.75rem;\n    font-size: 1rem;\n    font-weight: 600;\n    border-radius: 0.25rem;\n  }\n  \n  /* Fix background card styling */\n  .card.card-body.bg-light {\n    background: transparent !important;\n    border: none;\n    padding: 0;\n    margin-bottom: 0;\n    box-shadow: none;\n  }\n  \n  /* Remove unnecessary spacing */\n  .datagrid-table .formio-component {\n    margin-bottom: 0;\n  }\n  \n  /* Custom status indicators for selected rows */\n  .datagrid-table tbody tr.selected {\n    background-color: #f0f9ff;\n    border-left: 4px solid #0d6efd;\n  }\n  \n  /* Add visual distinction between adjacent rows */\n  .datagrid-table tbody tr:nth-child(even) {\n    background-color: #fbfbfb;\n  }\n  \n  /* Improve interactability with hover states */\n  .datagrid-table tbody tr:hover {\n    background-color: #f8f9fa;\n  }\n  \n  /* Add zebra striping for better readability on certain screen sizes */\n  @media screen and (max-width: 575px) {\n    .datagrid-table td:not(:first-of-type):nth-of-type(odd) {\n      background-color: rgba(0,0,0,0.01);\n    }\n  }\n  \n  /* Better handling for very small screens */\n  @media screen and (max-width: 359px) {\n    .datagrid-table td:before {\n      flex: 0 0 100%;\n      max-width: 100%;\n      margin-bottom: 0.25rem;\n    }\n    \n    .datagrid-table td {\n      flex-direction: column;\n      align-items: flex-start;\n      padding: 0.5rem;\n    }\n    \n    .datagrid-table td .formio-component {\n      flex: 0 0 100%;\n      max-width: 100%;\n      width: 100%;\n    }\n    \n    .datagrid-table td input[type="text"],\n    .datagrid-table td input[type="number"] {\n      text-align: center;\n    }\n  }\n  .\n}\n    </style>\n  </head>\n  <body data-sveltekit-preload-data="hover">\n    <div style="display: contents">' + body + '</div>\n    <script src="https://cdn.form.io/formiojs/formio.form.min.js"><\/script>\n  </body>\n</html>\n\n',
