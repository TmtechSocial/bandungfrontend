...
declare module '$env/static/private' {
	...
	export const VITE_CAMUNDA_API_URL: string;
	export const VITE_APP_ENDPOINT: string;
	export const VITE_CHEMISTRY_API_URL: string;
	export const VITE_INVENTREE_IMAGE: string;
	export const VITE_VAPID_KEY: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		VITE_API_URL: string;
		VITE_CAMUNDA_API_URL: string;
		VITE_APP_ENDPOINT: string;
		VITE_CHEMISTRY_API_URL: string;
		VITE_INVENTREE_IMAGE: string;
